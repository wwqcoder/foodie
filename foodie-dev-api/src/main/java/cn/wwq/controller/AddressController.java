...
public class AddressController {
    ...
    @ApiOperation(value = "添加地址列表",notes = "添加地址列表",httpMethod = "POST")
    @PostMapping("add")
    ...
    @ApiOperation(value = "更新地址列表",notes = "更新地址列表",httpMethod = "POST")
    @PostMapping("update")
    ...
    @ApiOperation(value = "删除地址列表",notes = "删除地址列表",httpMethod = "POST")
    @PostMapping("delete")
